...
const ETH_ERC20EXAMPLE_CONTRACT_ADDRESS = process.env
...
assert(
  ETH_ERC20EXAMPLE_CONTRACT_ADDRESS != undefined,
  'ETH_ERC20EXAMPLE_CONTRACT_ADDRESS env required'
);
assert(METAMASK_ADDRESS != undefined, 'METAMASK_ADDRESS env required');
